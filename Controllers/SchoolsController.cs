...
namespace SchoolProject.Controllers
{
    public class SchoolsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SchoolId,SchoolName,Street,City,State,County,ZipCode")] School school)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SchoolId,SchoolName,Street,City,State,County,ZipCode")] School school)
        {
